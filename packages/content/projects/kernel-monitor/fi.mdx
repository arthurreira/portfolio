...
description: "Yksityinen ja täysin paikallinen tapa tutkia yli 1,6 miljoonaa Linuxin tiedostojärjestelmätapahtumaa luonnollisella kielellä ja todellisten syscall-tietojen perusteella."
problem: "Linux-ytimen tiedostojärjestelmätapahtumia syntyy paljon, ja ne sisältävät arkaluonteisia tietoja. Tutkiminen ei saa lähettää SSH-avainten lukuja, salasanapolkuja tai yksityisiä tiedostonimiä pilvipalveluun."
outcome: "Kernel Monitor kaappasi yhden päivän aikana yli 1,6 miljoonaa todellista tapahtumaa. Paikallinen tekoäly tutkii prosesseja SQLiteen tallennettujen syscall-tietojen perusteella ilman API-kuluja tai koneelta poistuvaa dataa."
createdAt: "2026-06-07"
featured: true
role: "solo"
highlight: "eBPF-ytimentarkkailija — yli 1,6 miljoonaa kaapattua syscallia, paikallinen phi3:mini-tekoäly, live-kojelauta Macilta Linuxille WiFin kautta"
techStack:
  - "eBPF / BCC"
  - "Python"
  - "FastAPI"
