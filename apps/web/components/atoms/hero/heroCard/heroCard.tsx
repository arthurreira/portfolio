...
export default function HeroCard({ title, description, icon }: HeroCardProps) {
    ...
    return (
    <Card className="flex  g p-2 md:p-3 lg:p-4 bg-card text-card-foreground border border-border hover:translate-y-[-4px] transition-transform duration-200 shadow-md hover:shadow-lg">
        <div>
