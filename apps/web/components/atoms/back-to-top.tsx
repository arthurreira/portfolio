...
export function BackToTop() {
  ...
  return (
    <button
      ...
      className={cn(
        "border-border bg-background/80 text-muted-foreground fixed right-[calc(var(--page-inset)+1.25rem)] bottom-20 z-50 flex size-10 items-center justify-center border backdrop-blur transition-all duration-300",
